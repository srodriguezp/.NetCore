...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 53525215, ; hash 0x330badf, from name: PrimeraMAUIBlazor
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 118639418, ; hash 0x7124b3a, from name: libaot-PrimeraMAUIBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 9
	...
	%struct.DSOCacheEntry {
		i64 311423139, ; hash 0x128ff0a3, from name: PrimeraMAUIBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	...
	%struct.DSOCacheEntry {
		i64 1085081737, ; hash 0x40ad0889, from name: aot-PrimeraMAUIBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 138
	...
	%struct.DSOCacheEntry {
		i64 1126741321, ; hash 0x4328b549, from name: libaot-PrimeraMAUIBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 141
	...
	%struct.DSOCacheEntry {
		i64 3066673266, ; hash 0xb6c9b872, from name: aot-PrimeraMAUIBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 424
