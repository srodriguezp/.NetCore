...
@dso_cache = dso_local local_unnamed_addr global [570 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1848036443998153624, ; hash 0x19a58b5ac07c6b98, from name: PrimeraMAUIBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 46
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 5512453361335966102, ; hash 0x4c802b203b569996, from name: aot-PrimeraMAUIBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 6831301040245777203, ; hash 0x5ecda81a319b2333, from name: aot-PrimeraMAUIBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 181
	...
	%struct.DSOCacheEntry {
		i64 8504154058731077717, ; hash 0x7604d30f39dcc055, from name: PrimeraMAUIBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 246
	...
	%struct.DSOCacheEntry {
		i64 13898779198376588043, ; hash 0xc0e2620ac2d3330b, from name: libaot-PrimeraMAUIBlazor
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 434
	...
	%struct.DSOCacheEntry {
		i64 17326780538958848367, ; hash 0xf075171955cb216f, from name: libaot-PrimeraMAUIBlazor.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PrimeraMAUIBlazor.dll.so
		ptr null; void* handle (0x0)
	}, ; 538
...
@.env.3 = private unnamed_addr constant [37 x i8] c"2e12250e-902f-44c5-9e54-b674456c2c11\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.primeramauiblazor\00", align 1
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [32 x i8] c"libaot-PrimeraMAUIBlazor.dll.so\00", align 1
